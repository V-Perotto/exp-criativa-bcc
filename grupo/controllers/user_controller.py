...
def register():
    global db_users
    return render_template('/user/register.html', hrefs=hrefs, descriptions=descriptions, register_list = db_users)
...
def user_login():
    ...
    return render_template('/user/login.html', hrefs=hrefs, descriptions=descriptions, user_registered = is_valid)
